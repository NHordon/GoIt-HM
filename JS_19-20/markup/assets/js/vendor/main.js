...
console.log('1. Skills Array: ', skills);
console.log('2. Names Array: ', names);
console.log('3. Friends Aray: ', friends);
...
$(function() {
    ...
    var itemContent = $('.accordion-item__text').hide();
    var itemPanel = $('.accordion-item__panel');
